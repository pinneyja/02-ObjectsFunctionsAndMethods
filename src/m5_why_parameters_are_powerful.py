...
def main():
    ...
    even_better_draw_circles(rg.Point(100, 50), 15, 6, "red", 3)
    even_better_draw_circles(rg.Point(-200, 0), 2, 90, "blue", 1)
...
def better_draw_circles(point, interval):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(interval * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, interval, amount, color, thickness):
